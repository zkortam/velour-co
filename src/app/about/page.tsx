      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-black mb-6">Our Foundation</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white to-blue-50/30">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-black mb-4">Mission</CardTitle>
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white to-purple-50/30">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-black mb-4">Vision</CardTitle>
                <CardDescription className="text-gray-700 text-base leading-relaxed">
            ...
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white to-pink-50/30">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-black mb-4">Values</CardTitle>
                <CardDescription className="text-gray-700 text-base leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 text-center">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-black">Zakaria Kortam</CardTitle>
